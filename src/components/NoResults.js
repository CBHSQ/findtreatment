...
const NoResults = () => {
  return (
    <div css={tw`shadow border rounded p-6 text-center mb-6`}>
      <h2 css={tw`mb-6`}>
        <span css={tw`block font-bold text-2xl mb-6`}>We couldn't find any providers near you.</span>
      </h2>
      <div css={tw`max-w-md mx-auto`}>
        <p css={tw`mb-6`}>
          Try expanding your search by applying less filters, like your ZIP code and the type of treatment you need.
        </p>
        <p css={tw`mb-6`}>
