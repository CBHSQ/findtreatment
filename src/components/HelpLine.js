  ...
  return (
    ...
    >
      <a
        ...
        css={tw`w-full lg:w-auto lg:absolute lg:right-0 lg:mr-6 bg-red-700 text-white hover:text-white text-sm lg:rounded-b flex items-center lg:items-stretch justify-center lg:justify-start shadow-md`}
      >
